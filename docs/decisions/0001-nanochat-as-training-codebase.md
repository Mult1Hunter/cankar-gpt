...
The nanochat-over-nanoGPT/HF-Trainer rejection now heads the vendoring record, where the code it explains actually lives.

## Decision

Withdrawn as a standing record. The content lives at `docs/decisions/0016-training-stage.md`; this number
is retained so existing `ADR 0001` citations still resolve.
