...
VENDORED-AS-PORT from nanochat/nanochat/flash_attention.py @ 92d63d4 (ADR 0016):
only the COMPUTE_DTYPE import is repointed to cankar.model.compute; the FA3/SDPA
logic is verbatim. On CPU (and any non-FA3 GPU) this transparently falls back to
torch SDPA, so the model runs everywhere.
...
def _resolve_use_fa3():
    ...
    if HAS_FA3:
        ...
        from cankar.model.compute import COMPUTE_DTYPE
